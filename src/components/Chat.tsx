...
import { ArrowLeft, Send, Phone, Video, MoreVertical, Paperclip, Image, Smile, Search, Info } from "lucide-react";
...
const chatsList = [
  ...
  },
  {
    id: '3',
    name: 'Анна Смирнова',
    avatar: 'https://images.unsplash.com/photo-1494790108755-2616b612b8db?w=60&h=60&fit=crop&crop=face',
...
export function Chat({ propertyId, onBack }: ChatProps) {
  const [selectedChat, setSelectedChat] = useState<string | null>(propertyId ? '1' : null);
            ...
            <div className="flex flex-col h-screen">
              ...
              <div className="px-6 py-4 bg-white border-b border-gray-200">
                <div className="flex items-center">
                  <button onClick={() => setSelectedChat(null)} className="mr-4 p-2 hover:bg-gray-100 rounded-lg">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500">{selectedChatData?.propertyName}</p>
                  </div>
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">{filteredChats.length} чатов</p>
                    </div>
                  </div>
                </div>
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-500 mb-1">{chat.propertyName}</p>
          ...
          <div className="col-span-4 bg-white border-r border-gray-200 flex flex-col">
            ...
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="text-sm text-gray-500">{filteredChats.length} чатов</div>
              </div>
            ...
            {selectedChat && selectedChatData ? (
                ...
                <div className="px-8 py-6 bg-white border-b border-gray-200">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      <div>
                        <h3 className="text-xl text-black">{selectedChatData.name}</h3>
                        <p className="text-gray-500">{selectedChatData.propertyName}</p>
                        <p className="text-sm text-gray-400">
                          {selectedChatData.online ? 'В сети' : 'Был в сети недавно'}
                        </p>
                      </div>
                    </div>
              ...
              <div className="flex-1 flex items-center justify-center bg-gray-50">
                <div className="text-center">
                  ...
                  <p className="text-gray-500">Выберите беседу из списка слева, чтобы начать общение</p>
                </div>
              </div>
            )}
          </div>
