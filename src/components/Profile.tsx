...
import { ArrowLeft, User, Settings, Bell, Heart, Star, Calendar, MapPin, LogOut, Edit, Shield, CreditCard, Eye } from "lucide-react";
                  ...
                  <div className="bg-white rounded-xl border border-gray-200">
                    <button className="w-full flex items-center justify-between p-4 hover:bg-gray-50 transition-colors">
                      <div className="flex items-center">
                        ...
                        <span className="text-gray-700">История просмотров</span>
                      </div>
            ...
            <div className="p-8">
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-gray-500 mb-3">
                  {userType === 'buyer' ? 'Покупатель' : 'Застройщик • ООО "СтройИнвест"'}
                </p>
                {userType === 'developer' && (
                ...
                {userType === 'buyer' && (
                  <>
                    ...
                    >
                      ...
                      <span className="text-sm bg-gray-200 px-2 py-1 rounded-full">3</span>
                    </button>
                    ...
                    >
                      ...
                      <span className="text-sm bg-gray-200 px-2 py-1 rounded-full">12</span>
                    </button>
                  </>
                )}
          ...
          <div className="col-span-9 p-8">
            {activeTab === 'profile' && (
              <div className="max-w-2xl">
                ...
                <p className="text-gray-500 mb-8">Управляйте своими личными данными и настройками профиля</p>
                  ...
                  <form className="space-y-6">
                    <div className="grid grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          type="text"
                          defaultValue={userType === 'buyer' ? 'Анна' : 'Александр'}
                      ...
                      <div>
                        ...
                        <input
                          type="text"
                          defaultValue={userType === 'buyer' ? 'Смирнова' : 'Иванов'}
                          className="w-full bg-gray-100 rounded-lg px-4 py-3 border-0 outline-none focus:bg-white focus:ring-2 focus:ring-blue-500 transition-all"
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        type="email"
                        defaultValue={userType === 'buyer' ? 'anna.s@email.com' : 'alexander.i@stroyinvest.com'}
                        className="w-full bg-gray-100 rounded-lg px-4 py-3 border-0 outline-none focus:bg-white focus:ring-2 focus:ring-blue-500 transition-all"
                      />
                    </div>
            ...
            {activeTab === 'notifications' && (
              <div className="max-w-2xl">
                ...
                <p className="text-gray-500 mb-8">Настройте, какие уведомления вы хотите получать</p>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-center justify-between py-3 border-b border-gray-100">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Получать SMS о важных событиях</p>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer">
                    ...
                    {userType === 'buyer' && (
                      <div className="flex items-center justify-between py-3">
                        <div>
                          ...
                          <p className="text-sm text-gray-500">Уведомления о новых объектах недвижимости</p>
                        </div>
                        <label className="relative inline-flex items-center cursor-pointer">
                          <input type="checkbox" defaultChecked className="sr-only peer" />
                          <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                    ...
                    {userType === 'developer' && (
                      <div className="flex items-center justify-between py-3">
                        <div>
                          ...
                          <p className="text-sm text-gray-500">Уведомления о новых заявках от покупателей</p>
                        </div>
                        <label className="relative inline-flex items-center cursor-pointer">
                          <input type="checkbox" defaultChecked className="sr-only peer" />
                          <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
            ...
            {activeTab !== 'profile' && activeTab !== 'notifications' && (
              <div className="max-w-2xl">
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
                  ...
                  <p className="text-gray-500">Данный раздел находится в разработке</p>
                </div>
              </div>
            )}
          </div>
